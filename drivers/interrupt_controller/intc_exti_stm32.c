...
const IRQn_Type exti_irq_table[] = {
        EXTI1_0_IRQn, EXTI1_0_IRQn, EXTI3_2_IRQn, EXTI3_2_IRQn,
        EXTI15_4_IRQn, EXTI15_4_IRQn, EXTI15_4_IRQn, EXTI15_4_IRQn,
        EXTI15_4_IRQn, EXTI15_4_IRQn, EXTI15_4_IRQn, EXTI15_4_IRQn,
        EXTI15_4_IRQn, EXTI15_4_IRQn, EXTI15_4_IRQn, EXTI15_4_IRQn
};
...
#elif defined(CONFIG_SOC_STM32WL55XX) && defined(CONFIG_CPU_CORTEX_M0PLUS)
static inline void __stm32_exti_isr_1_0(const void *arg)
{
        __stm32_exti_isr(0, 2, arg);
}

static inline void __stm32_exti_isr_3_2(const void *arg)
{
        __stm32_exti_isr(2, 4, arg);
}

static inline void __stm32_exti_isr_15_4(const void *arg)
{
        __stm32_exti_isr(4, 16, arg);
}
#else
