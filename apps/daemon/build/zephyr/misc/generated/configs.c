...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IPM_STM32_IPCC2_PROCID, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STM32_HAL_PWR_EX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STM32_LL_UTILS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_WL55JC2_CM4, 1);
