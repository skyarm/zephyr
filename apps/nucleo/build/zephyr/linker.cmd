...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x8020000 + 0x0), LENGTH = (128*1K - 0x0)
    SRAM (wx) : ORIGIN = 0x20008000, LENGTH = (32 * 1K)
    ...
    IDT_LIST (wx) : ORIGIN = (0x20008000 + (32 * 1K)), LENGTH = 2K
    }
ENTRY("__start")
SECTIONS
    {
 ...
 *(.iplt)
 ...
 _image_rom_start = (0x8020000 + 0x0);
    rom_start :
 {
. = 0x0;
. = ALIGN(4);
 ...
 *(".kernel_noinit.*")
    ...
    _image_ram_end = .;
    _end = .;
    __kernel_ram_end = 0x20008000 + (32 * 1K);
