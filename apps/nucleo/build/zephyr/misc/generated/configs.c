...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_CLOCK_TICKS_PER_SEC, 4096);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_BASE_ADDRESS, 0x8020000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IPM_STM32_IPCC2, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IPM_STM32_IPCC2_PROCID, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_IPM_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USE_STM32_HAL_SUBGHZ, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_WL55JC2_CM0, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_BASE_ADDRESS, 0x20008000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STM32_LPTIM_CLOCK_LSE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STM32_LPTIM_CLOCK, 32768);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STM32_LPTIM_TIMEBASE, 0xFFFF);
